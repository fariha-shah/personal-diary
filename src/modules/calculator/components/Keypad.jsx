const base =
  'h-14 rounded-lg text-lg font-medium transition-all duration-150 active:scale-95';
...
const funcBtn = `${base} bg-navy-900 text-text-secondary hover:text-text-primary`;
const equalsBtn = `${base} bg-accent-blue text-white hover:bg-blue-600`;
